...
const controlRecipe = async function() {
    try {
        ...
        (0, _resultsViewJsDefault.default).update(_modelJs.getSortResultsPage());
        // Update bookmarks
...
const controlSearchResults = async function() {
    try {
        ...
        // Render results
        (0, _resultsViewJsDefault.default).render(_modelJs.getSortResultsPage());
        // Render pagination
...
const controlPagination = function(page) {
    (0, _resultsViewJsDefault.default).render(_modelJs.getSortResultsPage(page));
    (0, _paginationViewJsDefault.default).render(_modelJs.state.search);
};
...
const init = function() {
    ...
    (0, _recipeViewJsDefault.default).addHandlerUpdateServings(constrolServings);
...
parcelHelpers.export(exports, "getSortResultsPage", ()=>getSortResultsPage);
...
const loadSearchResults = async function(query) {
    try {
        ...
        state.search.page = 1;
    // console.log("state results(1): ", state.search.results);
    } catch (err) {
        throw err;
    }
};
const getSortResultsPage = function(page = state.search.page) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","url:../../img/icons.svg":"fd0vu","fracty":"gsPKI","./View.js":"jSw21"}],"fd0vu":[function(require,module,exports,__globalThis) {
...
class PaginationView extends (0, _viewJsDefault.default) {
    ...
    _generatePreviousPageMarkup(curPage) {
        return `
    ...
    _generateMarkup() {
        ...
        if (curPage === 1 && numPages > 1) return this._generateNextPageMarkup(curPage);
        // Last page
        if (curPage === numPages && numPages > 1) return this._generatePreviousPageMarkup(curPage);
        // Other page
        if (curPage < numPages) return `${this._generatePreviousPageMarkup(curPage)} ${this._generateNextPageMarkup(curPage)}`;
